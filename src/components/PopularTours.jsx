...
function PopularTours() {
  ...
  return (
    <section
      id="tours"
      ref={ref}
      className={`section popular ${isVisible ? "animate" : ""}`}
    >
        ...
        <ul className="popular-list">
          ...
          <li>
            <div className="popular-card">
              ...
              <figure className="card-banner">
                <img
                  src={`${process.env.PUBLIC_URL}/assets/images/popular-2.jpg`}
                  width="740"
                  height="518"
                  loading="lazy"
          ...
          <li>
            <div className="popular-card">
              ...
              <figure className="card-banner">
                <img
                  src={`${process.env.PUBLIC_URL}/assets/images/popular-3.jpg`}
                  width="740"
                  height="518"
                  loading="lazy"
